...
# Add Text
canvas1.create_text(200, 20, text="Taylor Swift Lyrics Quiz")
# open_label = Label(root, text="Hey ho ", font=("Satisfy", 24))
# open_label.pack(pady=20, anchor ="nw")
...
class StartGame:
    ...
    def __init__(self):
        ...
        # Strings for labels
        intro_string = "You will be present with lyrics from these 6 albums, try and guess them."

        # choose_string = "Oops - Please choose a whole number more than zero."
        choose_string = "How many rounds do you want to play?"
        # List of labels to be made (text | font | fg)
        start_labels_list = [
            ["Taylor Swift lyrics Quiz", ("Satisfy", 16, "bold"), None],
