...
class Play:
    ...
    def check_ans(self, idx):
        ...
        if selected == self.correct_choice:
            ...
            result_color = "red"
        # displays that text
        self.canvas_p.create_text(200, 180, text=result_text, fill=result_color, width=300, justify="center",
                                  font=("Arial", 11), tags="result")
...
class Stats:
    ...
    def __init__(self, partner, bundle):
        ...
        self.round_disp = self.canvas_s.create_text(135, 180, text=success_string, width=300,
                                                    justify="left", font=("Permanent Marker", 15, "bold"),
                                                    fill="#444959")
